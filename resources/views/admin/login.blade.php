  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="{{asset('assets')}}/admin/index2.html"><b>Admin</b>Login</a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>
        <form action="/loginadmincheck" method="post" enctype="multipart/form-data">
          @csrf
          ...
          <div class="row">
            <div class="col-xs-8">    
              <div class="checkbox icheck" name="check">
                <label>
